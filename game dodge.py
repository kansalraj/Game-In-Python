...
while restart:
 ...
 while running:
     ...
     survivedtext1 = font.render("SCORE"+":"+str(passed).zfill(3), True, (200,0,0))
 ...
 if exitcode==0:
     ...
     text1 = font.render("Score: "+str(passed), True, (255,0,0))
     if passed>high:
         high = passed
     textRect1 = text1.get_rect()
     textRect1.centerx = screen.get_rect().centerx
     textRect1.centery = screen.get_rect().centery+24
