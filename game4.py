...
while restart:
 ...
 goodguyimg1 = pygame.image.load("/home/ankit/Downloads/life(1).png")
 ...
 while running:
     ...
     font = pygame.font.Font(None, 100)
     stext = font.render(str((90000 + wait -pygame.time.get_ticks())/60000)+":"+str((90000 +wait -pygame.time.get_ticks())/1000%60).zfill(2), True, (0,0,0))
